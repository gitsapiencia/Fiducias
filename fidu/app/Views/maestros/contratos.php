            ...
            <div class="card-body custom-card-body">
                ...
                <div class="row">
                    <div class="form-group col-lg-3 col-6">
                        ...
                        <select class="form-control" id="operador_financiero" name="operador_financiero">
                            <!-- Recorre el objeto $fondos y agrega opciones según sus elementos -->
                            <?php
                    ...
                    <div class="form-group col-lg-3 col-6">
                        ...
                        <input type="text" class="form-control datepicker" id="fecha_inicial" name="fecha_inicial" placeholder="Fecha Inicial"
                        value="<?= isset($contrato['fecha_inicial']) ? esc($contrato['fecha_inicial']) : ''; ?>">
                    </div>
                    <div class="form-group col-lg-3 col-6">
                        <label for="fecha_final">Fecha Final</label>
                        <input type="text" class="form-control datepicker" id="fecha_final" name="fecha_final" placeholder="Fecha Final"
